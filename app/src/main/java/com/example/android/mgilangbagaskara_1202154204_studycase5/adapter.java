package com.example.android.mgilangbagaskara_1202154204_studycase5;
...
public class adapter extends RecyclerView.Adapter<adapter.holder> {
    ...
    public holder onCreateViewHolder(ViewGroup parent, int viewType) {
        //membuat view baru
        View view = LayoutInflater.from(conts).inflate(R.layout.cardviewlist, parent, false);
    ...
    public void onBindViewHolder(holder holder, int position) {
        ...
        holder.cardv.setCardBackgroundColor(conts.getResources().getColor(this.colors));
    }
